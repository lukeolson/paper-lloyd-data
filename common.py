...
class fig_size:
    textwidth = 370  # full columnwidth
    single12       = {'width': 187, 'height': 114}   # 1/2 width - 5pt (use with side-by-side)
    single13       = {'width': 118, 'height': 73}    # 1/3 width - 5pt (use with side-by-side-by-side)
    singlefull     = {'width': 360, 'height': 222}   # full width - 10pt


def set_figure(fontsize=8, width=251.0, heightratio=None, height=None):
    r"""
    Parameters
    ----------
    fontsize : float
